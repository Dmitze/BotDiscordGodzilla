...
- 🎨 **Markdown рендеринг** - перетворення markdown в зображення
...
### **🎨 Markdown рендеринг**
```bash
/render markdown:"# Заголовок\nЦе **жирний** текст і це *курсив* текст." theme:"dark"
/render markdown:"## Приклад коду\n\`\`\`javascript\nconsole.log('Привіт, світ!');\`\`\`" theme:"light"
```
...
- **Військове використання** - від $20/місяць
- **Державні установи** - від $20/місяць
