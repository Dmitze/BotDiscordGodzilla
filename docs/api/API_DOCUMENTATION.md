...
Гнучка команда пошуку по всіх документах ЗСУ з підтримкою фільтрації та кешування.
...
| --------------- | ------- | ------------ | ---------------------------- | ---------------------- |
| `запит`         | string  | ✅           | Пошуковий запит              | "особовий склад"       |
...
| `підрозділ`     | string  | ❌           | Назва підрозділу             | "1-й батальйон"        |
...
| Параметр   | Тип    | Обов'язковий | Опис                | Приклад                      |
| ---------- | ------ | ------------ | ------------------- | ---------------------------- |
| `запит`    | string | ✅           | Запит до AI         | "Проаналізуй особовий склад" |
...
- `особовий-склад` - Стан особового складу
