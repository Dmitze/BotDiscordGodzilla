...
# Посібник з RAG у Discord AI Assistant Bot

## 🎯 Вступ

Цей посібник описує, як увімкнути та використовувати RAG-пайплайн: Retriever → Augmenter → Generator.
...
> Безпека: усі кнопки/селекти у UI використовують підписані `customId` (HMAC + TTL) для захисту від підміни та повторного відтворення.
...
За використання `EMBEDDINGS_PROVIDER=openai` потрібен дійсний `OPENAI_API_KEY`.
